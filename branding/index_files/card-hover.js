...
function atvImg(){
	...
	function processMovement(e, touchEnabled, elem, layers, totalLayers, shine){
		...
		var bdst = bd.scrollTop || htm.scrollTop,
			...
			yRotate = (offsetX - dx)*(0.035 * wMultiple), //rotation for container Y
		...
		if(elem.firstChild.className.indexOf(' over') != -1){
			imgCSS += ' scale3d(1.035,1.035,1.035)';
		}
		...
		shine.style.transform = 'translateX(' + (offsetX * totalLayers) - 0.05 + 'px) translateY(' + (offsetY * totalLayers) - 0.05 + 'px)';	
